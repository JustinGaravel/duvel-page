...
gulp.task("validateHTML", function() {
  return gulp
    .src(["dev/html/*.html", "dev/html/**/*.html"])
    .pipe(htmlValidator());
});
...
gulp.task(
  "serve",
  ["compileCSSForDev", "compileJSForDev" /*'lintJS', 'validateHTML' */],
  function() {
    "use strict";
    ...
    gulp
      .watch("dev/scripts/*.js", ["compileJSForDev", "lintJS"])
      .on("change", reload);

    gulp
      .watch("dev/styles/**/*.scss", ["compileCSSForDev"])
      .on("change", reload);
    ...
    gulp.watch("dev/img/**/*").on("change", reload);
  }
);
